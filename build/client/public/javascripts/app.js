...
SocketListener = (function(_super) {
  ...
  SocketListener.prototype.onRemoteCreate = function(model) {
    if (model instanceof Application) {
      ...
      return this.collections[user_idx].add(model);
    }
  };
  ...
  SocketListener.prototype.onRemoteDelete = function(model) {
    if (model instanceof Application) {
      ...
      return this.collections[user_idx].remove(model);
    }
  };
...
buf.push(escape(null == __val__ ? "" : __val__));
buf.push('</h4></section><section><h4 class="title-user h4">');
var __val__ = t('manage your sharings')
buf.push(escape(null == __val__ ? "" : __val__));
...
with (locals || {}) {
var interp;
buf.push('<div class="clearfix"><div class="mod"><strong>' + escape((interp = user.hostUrl) == null ? '' : interp) + '</strong><label>' + escape((interp = user.shareID) == null ? '' : interp) + '</label></div><div class="buttons right w33"><button class="remove-user btn w100"><i class="fa fa-trash mr1"></i>|<span class="label">');
...
module.exports = ConfigApplicationsView = (function(_super) {
  ...
  ConfigApplicationsView.prototype.displayDevices = function() {
    console.log('display device : ' + JSON.stringify(this.devices));
...
module.exports = UserRow = (function(_super) {
  ...
  UserRow.prototype.className = "line config-device clearfix";
...
module.exports = HomeView = (function(_super) {
  ...
  function HomeView() {
    ...
    this.users = new UserSharingCollection(window.usersharing);
