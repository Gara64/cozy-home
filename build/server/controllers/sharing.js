...
var Album, NotificationsHelper, async, cache, clearance, clearanceCtl, cozydb, getDisplayName, localization, localizationManager, log, request;
...
module.exports.request = function(req, res, next) {
  var data, err, message, messageKey, notificationSlug, notifier, sourceURL, _ref;
  console.log('request for a new sharing from proxy');
  if (req.params != null) {
    console.log('params : ' + JSON.stringify(req.params.sourceURL));
  }
  if (((_ref = req.params) != null ? _ref.sourceURL : void 0) == null) {
