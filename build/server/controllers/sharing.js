...
var Album, Client, NotificationsHelper, Sharing, UserSharing, answer, async, cache, clearance, clearanceCtl, clientDS, cozydb, create, createShare, createUserSharing, getCredentials, getDisplayName, getUser, getUserPassword, localization, localizationManager, log, randomString, updateOrCreate, _ref;
...
answer = function(sharing, callback) {
  ...
  if (sharing.accepted === true) {
    return getUser(sharing.url, function(err, user) {
      return getCredentials(user, function(err, password) {
